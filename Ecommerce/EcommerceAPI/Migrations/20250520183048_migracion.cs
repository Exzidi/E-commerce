        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Category_ProductCategory_ProductCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImage_ProductCategory_ProductCategoryId",
                        column: x => x.ProductCategoryId,
                        principalTable: "ProductCategory",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategory_Name_CategoryId",
                table: "ProductCategory",
                columns: new[] { "Name", "CategoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductImage_Image_ProductId",
                table: "ProductImage",
                columns: new[] { "Image", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductImage_ProductCategoryId",
                table: "ProductImage",
                column: "ProductCategoryId");
